  ...
  return (
    <>
      ...
      <div className="sm:hidden flex flex-col h-screen bg-gray-100">
        <div className="bg-gray-800 mt-14 text-white flex justify-between items-center px-4 py-3 fixed top-0 left-0 right-0 z-50">
        ...
        <div
          className={`fixed mt-4 top-16 left-0 w-64 h-full bg-gray-800 p-6 z-40 transition-transform duration-300 ${
        ...
        {/* Content Area */}
        <div className="mt-24 p-4 bg-slate-600 overflow-auto flex-1">
